...
// Params for testing
const PARAMS = {
    dbname: 'test/sqlite/testdb.sqlite',
    migrations_dir: 'test/sqlite/migrations',
    restored_dir: 'test/sqlite/restored_migrations',
}
...
SQLite3('Database created',async ctx => {
    ok(await utils.isExists(PARAMS.dbname),'File exists');
